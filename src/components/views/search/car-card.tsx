...
const CarCard = () => {
  return (
    <div className="border bg-white shadow rounded-lg px-4 py-[26px]">
      <div className="flex gap-x-3">
        <div className="relative w-[184px] h-[148px] z-10">
          <div className="absolute w-[148px] h-[148px] -z-10 rounded-full bg-[#FFEBE8]"></div>
          <Image
        ...
        <div className="ml-2 w-[calc(100%-200px)]">
          <div className="text-xl font-semibold">Maruti suzuki XL 6</div>
          <div className="flex gap-x-3 my-2">
            <div className="flex items-center">
              ...
              <div className="ml-1 text-sm text-[#565656]">5 seater</div>
            </div>
            <div className="flex items-center">
              <div>
                <svg
              ...
              <div className="ml-1 text-sm text-[#565656]">Manual</div>
            </div>
            <div className="flex items-center">
              <div>
                <svg
          ...
          <div className="flex items-center text-sm gap-x-3 mb-5">
            <div className="text-[#565656]">
              Free km : <span className="text-black font-bold">105</span>
            </div>
            <div className="text-[#565656]">
              Extra @ : <span className="text-black font-bold">8.0/km</span>
            </div>
          </div>

          <div className="flex items-center justify-between">
            <div className="text-xl font-semibold">$1556.06</div>
            <div>
              <button
                type="button"
                className="text-white bg-[#EF3C23] px-6 py-2 rounded-xl uppercase"
              >
                Book
              </button>
            </div>
